...
class CreateCustomersTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Customers", 'customers', 'name', 'fa-user', [
            ["name", "Name", "Name", false, "", 5, 256, true],
            ["email", "Email", "Email", false, "", 0, 256, true],
            ["password", "Password", "Password", false, "", 6, 255, true],
            ["customertype", "Customer Type", "Multiselect", false, "Free", 0, 256, false, ["Free","Preiume"]],
            ["status", "Status", "Checkbox", false, "0", 0, 0, false],
            ["activated", "Activated", "Checkbox", false, "0", 0, 0, false],
        ]);
